    ...
    >
      <Router>
        {user ? (
          ...
          // ✅ General-appeal explainer + auth (evergreen, no seasonal copy)
          <div className="landing-page" style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                See what's happening around you — no followers required.
              </p>
            </div>
            ...
            <div style={{
              ...
              <div className="fan-card fan-card-left" style={{
                position: "absolute",
                top: "10px",
                left: "0",
                width: "190px",
                ...
                <img
                  ...
                  alt="Corkt global feed"
                  style={{ width: "100%", display: "block" }}
                />
              </div>

              <div className="fan-card fan-card-right" style={{
                position: "absolute",
                top: "10px",
                right: "0",
                width: "190px",
                ...
                <img
                  ...
                  alt="Corkt profile with photo map"
                  style={{ width: "100%", display: "block" }}
                />
              </div>

              <div className="fan-card fan-card-center" style={{
                position: "absolute",
                top: "0",
                left: "50%",
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div>
                  <p style={{ margin: "0 0 4px 0", fontWeight: "600", fontSize: "14px", color: "var(--color-text-primary)" }}>
                    Local Feed
                  </p>
                  <p style={{ margin: 0, fontSize: "13px", color: "var(--color-text-muted)", lineHeight: "1.4" }}>
                    See photos from everyone around you, right now.
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: "13px", color: "var(--color-text-muted)", lineHeight: "1.4" }}>
                    Browse what's being shared everywhere, not just nearby.
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: "13px", color: "var(--color-text-muted)", lineHeight: "1.4" }}>
                    Tag your moments, find what's trending.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* No Download Callout */}
            <div style={{ textAlign: "center", padding: "8px 0 32px 0" }}>
              <p style={{
                margin: 0,
                fontSize: "13px",
              ...
              <div style={{ maxWidth: "400px", margin: "0 auto" }}>
                ...
                {authView === 'login' && (
                  <div style={{
                    ...
                    <div style={{ textAlign: "center", marginBottom: "24px" }}>
                      <h2 style={{ fontSize: "20px", color: "var(--color-text-primary)", fontWeight: "600", margin: "0 0 4px 0" }}>
                        Welcome back
                      </h2>
                    ...
                    <div style={{ textAlign: "center", color: "var(--color-text-muted)", margin: "24px 0 16px 0" }}>
                      <span
                        onClick={() => setAuthView('forgot')}
                        style={{ color: "var(--color-primary)", cursor: "pointer", fontSize: "14px", textDecoration: "underline" }}
                      >
                        Forgot your password?
                      </span>
                    </div>

                    <div style={{ textAlign: "center", color: "var(--color-text-muted)", margin: "16px 0", position: "relative" }}>
                      <div style={{ position: "absolute", top: "50%", left: "0", right: "0", height: "1px", background: "var(--color-border)" }}></div>
                      <span style={{ background: "var(--color-bg-secondary)", padding: "0 16px" }}>
                        or
                      </span>
                    </div>
                ...
                {authView === 'signup' && (
                  <div style={{
                    ...
                    <div style={{ textAlign: "center", color: "var(--color-text-muted)", margin: "24px 0", position: "relative" }}>
                      <div style={{ position: "absolute", top: "50%", left: "0", right: "0", height: "1px", background: "var(--color-border)" }}></div>
                      <span style={{ background: "var(--color-bg-secondary)", padding: "0 16px" }}>
                        or
                      </span>
